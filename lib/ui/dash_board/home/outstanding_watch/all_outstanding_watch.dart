...
class AllOutstandingWatchScreen extends StatefulWidget {
  const AllOutstandingWatchScreen({super.key});

  @override
  State<AllOutstandingWatchScreen> createState() =>
      _AllOutstandingWatchScreenState();
}

class _AllOutstandingWatchScreenState extends State<AllOutstandingWatchScreen> {
  bool isLoaded = false;
  ...
  void initState() {
    BlocProvider.of<ProductBloc>(context)
        .add(GetOutstandingProductEvent(limit: 50, page: 1, isViewAll: true));
    super.initState();
  }
